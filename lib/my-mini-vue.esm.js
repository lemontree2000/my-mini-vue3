...
function createRenderer(options) {
    ...
    // n1 ->新 n2 =>旧
    function patch(n1, n2, container, currentComponent) {
    ...
    function processComponent(n1, n2, container, currentComponent) {
    ...
    function processElement(n1, n2, container, currentComponent) {
        if (!n1) {
    ...
    function mountChildren(children, container, currentComponent) {
        children.forEach((v) => {
            patch(null, v, container, currentComponent);
        });
    }
    function processFragment(n1, n2, container, currentComponent) {
...
export { createApp, createRenderer, createTextVNode, effect, getCurrentInstance, h, inject, provider, proxyRefs, ref, renderSlots };
